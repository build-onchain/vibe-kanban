...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::tasks::CreateAndStartSwarmTaskRequest::decl(),
        server::routes::tasks::CreateAndStartSwarmTaskResponse::decl(),
        ...
        server::routes::task_swarm::SwarmWorkerInput::decl(),
        server::routes::task_swarm::SwarmAssignmentPlan::decl(),
        server::routes::task_swarm::SwarmPlan::decl(),
        server::routes::task_swarm::SwarmTaskExecution::decl(),
